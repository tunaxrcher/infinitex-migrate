        ...
        if (!DRY_RUN) {
          ...
          await newDb.loans.create({
              data: {
                ...
                latitude: helpers.parseCoordinates(loan.link_map).latitude?.toString() || undefined,
                longitude: helpers.parseCoordinates(loan.link_map).longitude?.toString() || undefined,
